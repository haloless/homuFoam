...
void Foam::IBInteractionLists<ParticleType>::buildInteractionLists()
{
    Info<< "Building IBInteractionLists with interaction distance "
        << maxDistance_ << endl;
...
template<class ParticleType>
void Foam::IBInteractionLists<ParticleType>::findExtendedProcBbsInRange
(
...
template<class ParticleType>
void Foam::IBInteractionLists<ParticleType>::buildMap
(
...
template<class ParticleType>
void Foam::IBInteractionLists<ParticleType>::prepareParticlesToRefer
(
...
template<class ParticleType>
void Foam::IBInteractionLists<ParticleType>::prepareParticleToBeReferred
(
...
template<class ParticleType>
void Foam::IBInteractionLists<ParticleType>::fillReferredParticleCloud()
{
    if (writeCloud_)
    {
...
template<class ParticleType>
void Foam::IBInteractionLists<ParticleType>::prepareWallDataToRefer()
{
    const globalIndexAndTransform& globalTransforms =
        mesh_.globalData().globalTransforms();
...
template<class ParticleType>
void Foam::IBInteractionLists<ParticleType>::writeReferredWallFaces() const
{
...
template<class ParticleType>
Foam::IBInteractionLists<ParticleType>::IBInteractionLists(const polyMesh& mesh)
:
    mesh_(mesh),
...
template<class ParticleType>
Foam::IBInteractionLists<ParticleType>::IBInteractionLists
(
    const polyMesh& mesh,
    scalar maxDistance,
    Switch writeCloud,
...
template<class ParticleType>
void Foam::IBInteractionLists<ParticleType>::sendReferredData
(
    const List<DynamicList<ParticleType*> >& cellOccupancy,
...
)
{
    if (mesh_.changing())
    {
        ...
        (
            ...
            << "Mesh changing, rebuilding IBInteractionLists form scratch."
            << endl;
...
template<class ParticleType>
void Foam::IBInteractionLists<ParticleType>::receiveReferredData
(
    PstreamBuffers& pBufs,
